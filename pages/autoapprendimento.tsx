...
function Auto() {
  ...
  lineHeight="shorter"
>
  Remote Control in Self-Learning Mode
</chakra.h1>

<chakra.p fontSize={"xl"} mb={10} maxW="1000px">
  To insert the new HERMES.MF remote control into the receiver, press and hold the remote control button until the LED starts flashing green, and wait until the flashing completes.
</chakra.p>
<br />
<chakra.p mb={10}>
  Below is the procedure for duplicating a remote control with Rolling Code and self-learning:
</chakra.p>
{" "}
